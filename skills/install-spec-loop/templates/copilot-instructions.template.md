---
name: Spec Loop fallback governance
description: >-
  Fallback GitHub Copilot project instructions for loading Spec Loop
  governance when equivalent higher-level harness instructions are not already
  active.
applyTo: '**'
---
