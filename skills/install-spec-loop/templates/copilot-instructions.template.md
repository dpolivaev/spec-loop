---
name: Spec Loop project governance
description: >-
  GitHub Copilot project instructions for loading Spec Loop governance when
  equivalent higher-level harness instructions are not already active.
applyTo: '**'
---
